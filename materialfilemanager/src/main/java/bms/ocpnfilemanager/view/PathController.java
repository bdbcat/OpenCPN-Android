...
package bms.ocpnfilemanager.view;
...
public interface PathController {
     ...
     * See {@link bms.ocpnfilemanager.view.widget.PathView#switchToManualInput() switchToManualInput()}
     * and {@link bms.ocpnfilemanager.view.widget.PathView#switchToStandardInput() switchToStandardInput()}.
     */
    enum Mode {
        /**
    ...
    /**
     * @see bms.ocpnfilemanager.view.widget.PathView#cd(File)
     * @param path
