...
public class SearchResultsProvider extends ContentProvider {
	...
	public static final String SEARCH_MIMETYPE = "vnd.android.cursor.item/vnd.myfilemanager.search_result";
	public static final String PROVIDER_NAME = "bms.myfilemanager.search";
