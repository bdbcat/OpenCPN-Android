...
package bms.ocpnfilemanager.provider;
...
public class BookmarkProvider extends ContentProvider implements BaseColumns {
    ...
    public static final String PROVIDER_NAME = "bms.myfilemanager.bookmarks";
    public static final Uri CONTENT_URI = Uri.parse("content://"+PROVIDER_NAME);
    //todo check following if dir has to be removed
    public static final String BOOKMARK_MIMETYPE = "vnd.android.cursor.item/vnd.myfilemanager.bookmark";
    public static final String BOOKMARKS_MIMETYPE = "vnd.android.cursor.dir/vnd.myfilemanager.bookmark";
    ...
    private static final String DATABASE_NAME = "bms.myfilemanager.filemanager";
