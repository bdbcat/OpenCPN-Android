...
package bms.ocpnfilemanager.adapter;
...
import bms.ocpnfilemanager.misc.ThumbnailHelper;
import bms.ocpnfilemanager.view.ViewHolder;
...
public class BookmarkListAdapter extends CursorAdapter {
    ...
    public void bindView(View convertView, Context context, Cursor cursor) {
        ViewHolder holder = (bms.ocpnfilemanager.view.ViewHolder) convertView.getTag();
