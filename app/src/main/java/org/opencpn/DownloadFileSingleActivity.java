...
public class DownloadFileSingleActivity extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState)
    {
        ...
        destinationFileName = extras.getString("dest_file");
        Log.d("OpenCPN", "DFSA destinationFileName: " + destinationFileName);
//        fileURL = extras.getString("URL");
    ...
    class DownloadSingleFileAsync extends AsyncTask<String, Integer, String> {
        ...
        protected void onPreExecute() {
            Log.i("OpenCPN", "DFSA onPreExecute");
        ...
        protected String doInBackground(String...  url) {
            ...
            downloadSingleFile(url[0], destinationFileName);
            return "OK";
        }

        protected String downloadSingleFile(String url, String dest) {
            long lengthOfFile = 0;
            ...
            try {
                ...
                Log.d("OpenCPN DFSA ExceptionA1", e.getMessage());

                Log.i("OpenCPN", "DFSA ERROR_NO_CONNECTION");
        ...
        protected void onPostExecute(String unused) {
            Log.i("OpenCPN", "DFSA onPostExecute");
            ...
            if(mDialogShown){
                try{
                    ...
                    Log.d("OpenCPN", "DFSA dialog illegal arg exception");
                }
            }
